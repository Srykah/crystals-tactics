...
bool Entitydt::loadFromNode(const pugi::xml_node& node)
{
...
bool Entitydt::loadFromFile(const sf::String& filename)
{
...
const AnimationData& Entitydt::getAnim(const sf::String& animName, Direction::Dir facing) const
{
