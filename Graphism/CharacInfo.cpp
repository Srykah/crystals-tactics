...
CharacInfo::CharacInfo(State::Context context, Character* charac)
...
void CharacInfo::handleInput(const sf::Event& event, IH::SA stdAction, sf::Vector2f mousePos)
{
...
void CharacInfo::fillTexts()
{
    if (mCharacter != nullptr)
    {
        ...
        mJobText.setString(convertTypeToString(mCharacter->getType()));
